...
export const SharedModal = (props: any) => {
  const { show, amount, setAmount, toggleModal, onNext, onClose, closeModal, days, setDays, setShowPopup } = props
      ...
      <CardBackground show={show} onMouseDown={handleClickOutside}>
        <CardContainer>
          ...
          <HeaderLayout>
            ...
            <HeaderContent>Supply assets to earn APR</HeaderContent>
            <HeaderButtonWrapper>
              <div>
          ...
          <Row3>
            <Rightsinglebox>
              ...
              <RightSideContent2>My total supplied</RightSideContent2>
            </Rightsinglebox>
          ...
          <MarginStyle>Your suppllied assets will be used as a colleteral </MarginStyle>
