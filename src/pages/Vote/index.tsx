...
import { JSBI, TokenAmount, ChainId } from '@spherium/swap-sdk'
  ...
  return (
    <PageWrapper gap="lg" justify="center">
      ...
      <TopSection gap="md">
        <VoteCard>
          <CardNoise />
          <CardSection style={{maxWidth: 1075, width: "100%"}}>
            <AutoColumn gap="md" style={{maxWidth: 1075, width: "100%", paddingLeft: 20, paddingRight: 20}}>
              <RowBetween>
                <TYPE.white fontWeight={600}>Spherium Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                SPHRI tokens represent voting shares in Spherium governance. You can vote on each proposal yourself or
              ...
              >
                ...
                <TYPE.white fontSize={14}>Read more about Spherium governance</TYPE.white>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
          <CardNoise />
      ...
      <TopSection gap="2px" style={{display: "block", maxWidth: 1075, width: "100%"}}> 
        <WrapSmall >
      ...
      <TYPE.subHeader color="text3">
        A minimum threshhold of 1% of the total SPHRI supply is required to submit proposals
      </TYPE.subHeader>
    </PageWrapper>
  )
}
