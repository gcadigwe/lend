...
export const WithDrawNowButton = styled.button`
  ...
  cursor: pointer;
`
export const Lowerbuttonwrapper = styled.div`
  display: flex;
  justify-content: space-between;
  margin-top: 10px;
`

export const Rightbuttonwarpper = styled.div`
  display: flex;
  flex-direction: row;
  justify-content: center;
  align-items: center;
...
`
export const RightbuttonContain = styled.div`
  width: 95px;
  height: 18px;
...
export const Leftwrapper = styled.div`
  ...
  /* Light Shade/White_600 */

  background: rgba(255, 255, 255, 0.05);
  /* Light Shade/White_500 */
...
export const Leftbuttoncontain = styled.div`
  width: 78px;
  height: 28px;
