...
import {
  ...
  StakeContent,
  LowerContent
} from './Confirmunstakingstyle'
export const Confirmunstaking = (props: any) => {
  const { days,show , toggleModal, children,onClose } = props
    ...
    <CardBackground show={show} onMouseDown={handleClickOutside}>
      <CardContainer>
        ...
        <Innerwrapper>
          ...
          <LowerContent>{totalstake} BTC at {Apr}% APY,{days}</LowerContent>
        </Innerwrapper>
      </CardContainer>
    </CardBackground>
  )
