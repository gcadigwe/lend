...
export const UnstakeBTC = (props: any) => {
  const { show, toggleModal, children, amount, setAmount, setShow, onClose, onNext, withDays, days, setDays ,setShowPopup } = props
      ...
      <CardContainer>
        ...
        <HeaderLayout>
          ...
          <HeaderButtonWrapper>
            ...
            <div>
              <DaysButton>{days} day</DaysButton>
            </div>
          </HeaderButtonWrapper>
        </HeaderLayout>
        <WithdrawDepositTabsLayout>
