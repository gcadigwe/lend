...
import CardModal from '../staking/CardModal'
      ...
      <BodyContent>
        ...
        {chainId && (
          <ContentWrapper>
            <Loader open={loading} />
            <UpperContainer>
              <StakingHead>HyperStake</StakingHead>
              <AllboxLpwrapper>
                <Allbox style={{ backgroundColor: selectTab === 1 ? 'gray' : '' }} onClick={() => setSelectTab(1)}>
                  <AllBoxContain>All</AllBoxContain>
                </Allbox>
                <Assetbox style={{ backgroundColor: selectTab === 2 ? 'gray' : '' }} onClick={() => setSelectTab(2)}>
                  <AssetboxContain>Assets</AssetboxContain>
                </Assetbox>
                <LpBox style={{ backgroundColor: selectTab === 3 ? 'gray' : '' }} onClick={() => setSelectTab(3)}>
                  <LpContain>Lp</LpContain>
                </LpBox>
              </AllboxLpwrapper>

              <SearchBarContainer>
                <SearchLogo src={SearchIcon} />
                <SearchBarContain placeholder="Search Assets/Lp By name or symbol" />
              </SearchBarContainer>
              <ToggleContainer>
                <ShowContain>Show Staked</ShowContain>
                <CheckBoxWrapper>
            ...
            <UpperMobileContainer>
              <UpperRow1>
                <StakingHead> Staking</StakingHead>
                <AllboxLpwrapper>
                  <Allbox>
                    <AllBoxContain>All</AllBoxContain>
                  </Allbox>
              ...
              <LowerRow2>
                <SearchBarContainer>
                  <SearchLogo src={SearchIcon} />
                  <SearchBarContain placeholder="Search Assets" />
                </SearchBarContainer>
                <CheckBoxWrapper>
                  <CheckBox id="checkbox" type="checkbox" />
                  <CheckBoxLabel htmlFor="checkbox" />
            ...
            <LowerWrapper>
              <CardModal
                ...
                tagline="Stake Asset to earn SPHRI"
                apr="32.65% APR"
                eachrow1Value1="Total Staked"
                eachrow1Value2="0.0 BTC"
                eachrow2Value1="Total Earned"
                eachrow2Value2="0.00 SPHRI"
                eachrow3Value1="Duration"
              ...
              <CardModal
                ...
                apr="32.65% APR"
                eachrow1Value1="Total staked"
                eachrow1Value2="01.0432ETH"
                eachrow2Value1="Total Earned"
                eachrow2Value2="232.0432 SPHRI"
                eachrow3Value1="Duration"
                eachrow3Value2="24 days"
              ...
              <CardModal
                img={Filecoil}
                mainhead="File coin FIL"
                tagline="Stake Asset to earn USDT"
                apr="32.65% APR"
                eachrow1Value1="Total staked"
                eachrow1Value2="0.0 BTC"
                eachrow2Value1="Total Earned "
                eachrow2Value2="0.00 USDT"
                eachrow3Value1="Duration"
                eachrow3Value2="24 days"
              ...
              <CardModal
                img={BtcEthlogo}
                mainhead="BTC/ETH"
                tagline="Stake LP to earn SPHRI"
                apr="32.65% APR"
                eachrow1Value1="Total staked"
                eachrow1Value2="0.0 BTC/ETH"
                eachrow2Value1="Total Earned"
                eachrow2Value2="0.00 SPHRI"
                eachrow3Value1="Duration"
              ...
              <CardModal
                ...
                apr="32.65% APR"
                eachrow1Value1="Total staked"
                eachrow1Value2="0.0BTC/ETH"
                eachrow2Value1="Total Earned"
                eachrow2Value2="0.0 SPHRI"
                eachrow3Value1="Duration"
                eachrow3Value2="24 days"
                buttonhead="Staked Asset"
                setShowPopup={setShowPopup}
