...
export function useV1Trade(
  ...
  const inputIsETH = (inputCurrency === ETHER || inputCurrency === BNB || inputCurrency === MATIC || inputCurrency === AVAX)
  const outputIsETH = (outputCurrency === ETHER || outputCurrency === BNB || outputCurrency === MATIC || outputCurrency === AVAX)
