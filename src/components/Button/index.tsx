...
export const ButtonPrimary = styled(Base)`
  ...
  border: solid 1px #5b94ed;
  color: white;
  font-weight: 600;
  font-size: 18px;

  &:focus {
    background: linear-gradient(107.84deg, #509fb8 9.82%, #6c34b4 139.48%);
  }
  &:hover {
  ...
  &:disabled {
    ...
    color: ${({ theme, altDisabledStyle, disabled }) =>
      altDisabledStyle ? (disabled ? 'rgba(255, 255, 255, 0.4)' : 'white') : 'rgba(255, 255, 255, 0.4)'};
    cursor: auto;
    box-shadow: none;
    border: 1px solid transparent;
    outline: none;
...
// margin: 0px 162px 0px 140px;
// padding: 16px 135px 15px;
 //width: 460px;
...
export const ButtonSecondary = styled(Base)`
  border: solid 1px ${({ theme }) => theme.text8};
