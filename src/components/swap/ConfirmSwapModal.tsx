import { currencyEquals, Trade, ChainId, BNB } from '@spherium/swap-sdk'
...
export default function ConfirmSwapModal({
  ...
  const pendingText = `Swapping ${trade?.inputAmount?.toSignificant(6)}
   ${(chainId === ChainId.BSC_TESTNET || chainId === ChainId.BSC_MAINNET) && trade?.inputAmount.currency.symbol === 'ETH'
      ? BNB.symbol
