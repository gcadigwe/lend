...
import CurrencyList from './XCHAINCurrencyList'
      ...
      <PaddedColumn gap="14px">
        <RowBetween>
          <Text fontWeight={500} fontSize={16}>
            Select a Blockchain
            <QuestionHelper text="Find a blockchain by searching for its name or symbol or by pasting its address below." />
          </Text>
        ...
        <AutoSizer disableWidth>
          {({ height }) => (
            <CurrencyList
              ...
              showImportView={() => console.log("test1")}
              setImportToken={() => console.log("test2")}
            />
          )}
        </AutoSizer>
      </div>
