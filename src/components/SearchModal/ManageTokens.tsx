    ...
    <Wrapper>
      <Column style={{ width: '100%', flex: '1 1' }}>
        <PaddedColumn gap="14px">
          ...
          {searchToken && (
            <Card style={{backgroundImage: "linear-gradient(to right, #5b94ed -14%, #5960f7 106%)"}} padding="10px 0">
              <ImportRow
                token={searchToken}
        ...
        <PaddedColumn gap="lg" style={{padding: 20, paddingTop: 0}}>
        
          <RowBetween style={{justifyContent: "center", paddingTop: 20}} >
      ...
      <Footer>
        <TYPE.darkGray fontSize={16} fontWeight={500}>Tip: Custom tokens are stored locally in your browser</TYPE.darkGray>
      </Footer>
    </Wrapper>
  )
}
