...
const ListRow = memo(function ListRow({ listUrl }: { listUrl: string }) {
  ...
  return (
    <RowWrapper active={isActive} bgColor={'transparent'} key={listUrl} id={listUrlRowHTMLId(listUrl)}>
      {list.logoURI ? (
    ...
    <Wrapper>
      ...
      {tempList && (
        <PaddedColumn style={{ paddingTop: 0 }}>
          <Card
            style={{ backgroundImage: 'linear-gradient(to right, #ACB6E5 -14%, #74ebd5 106%)' }}
            padding="12px 20px"
          >
            <RowBetween>
              <RowFixed>
      ...
      <ListContainer>
        <AutoColumn gap="md" style={{ display: 'block', paddingBottom: 80 }}>
