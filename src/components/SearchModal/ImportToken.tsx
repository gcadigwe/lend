...
import { Token, Currency } from '@spherium/swap-sdk'
...
export function ImportToken({ tokens, onBack, onDismiss, handleCurrencySelect }: ImportProps) {
  ...
  return (
    <Wrapper>
      <PaddedColumn gap="14px" style={{ width: '100%', flex: '1 1', padding: 0 }}>
        <RowBetween style={{ justifyContent: 'space-between', padding: 10 }}>
      ...
      <SectionBreak />
      <PaddedColumn gap="md" style={{ display: 'grid' }}>
        {tokens.map(token => {
