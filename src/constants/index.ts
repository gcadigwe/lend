import { ChainId, JSBI, Percent, Token, WETH } from '@spherium/swap-sdk'
import { AbstractConnector } from '@web3-react/abstract-connector'
import UAuth from '@uauth/js'

import { fortmatic, portis, injected, uauth, walletconnect, walletlink } from '../connectors'

export const ROUTER_ADDRESS = '0xA9528eC8440cb0443822719d5F6dA07Ff77C3E68' //Spherium router address
...
export const UNI: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.ARBITRUM_MAINNET]: new Token(ChainId.ARBITRUM_MAINNET, UNI_ADDRESS, 18, 'UNI', 'Uniswap'),
...
export const CHAIN_LABELS: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.BSC_TESTNET]: 'Smart Chain Test',
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.MATIC]: [...WETH_ONLY[ChainId.MATIC], B_DAI, BUSD, B_USDT]
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.MATIC]: [...WETH_ONLY[ChainId.MATIC], T_USDT, T_BUSD, T_DAI],
  [ChainId.MUMBAI]: [...WETH_ONLY[ChainId.MUMBAI], T_USDT, T_BUSD, T_DAI]
}
...
export interface WalletInfo {
  connector?: AbstractConnector | UAuth
  name: string
  iconName: string
  description: string
  href: string | null
...
export const SUPPORTED_WALLETS: { [key: string]: WalletInfo | any | UAuth } = {
  INJECTED: {
    connector: injected,
    name: 'Injected',
